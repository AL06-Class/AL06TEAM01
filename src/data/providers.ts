...
export const helpers: Helper[] = [
  ...
  },
  {
    id: "provider-minseok",
    name: "김민석",
    imageUrl: "/figma-assets/provider-minseok.jpg",
    distance: "제주시 조천읍 · 1.2km",
    price: 15000,
    rating: 4.9,
    reviewCount: 8,
    completedCount: 12,
    badges: ["본인확인 완료", "운영검증 완료"],
    trustItems: ["본인확인 완료", "운영검증 완료", "진행 기록 공유 가능"],
    quote: "약속한 시간에 맞춰 차분하게 동행하고, 이동 중에도 보호자분께 진행 상황을 꼼꼼히 알려드립니다.",
    description: "약보기 동행과 생활 보조를 신뢰감 있게 진행합니다."
  },
  {
    id: "provider-lee",
    name: "최하늘",
    imageUrl: "/figma-assets/provider-sungho.jpg",
    distance: "제주시 노형동 · 1.8km",
    price: 13000,
    rating: 4.8,
    reviewCount: 89,
    completedCount: 74,
    ...
    quote: "노형동에서 성실함으로 소문난 청년입니다. 무거운 짐이나 복잡한 심부름도 지치지 않는 체력으로 돕겠습니다.",
