  ...
  return (
    <main className="app-shell" id="top">
      ...
      <div className="content-stack">
        ...
        <section
          className="journey-section request-journey"
          id="apply"
          ref={requestSectionRef}
          aria-labelledby="request-journey-title"
        >
          <div className="journey-header">
            <p className="eyebrow">돌봄 신청</p>
          ...
          <div className="request-layout">
            <CareRequestForm
              ...
              onToggleCareType={onToggleCareType}
      ...
      <FinalCtaBanner onStartRequest={scrollToRequest} />
